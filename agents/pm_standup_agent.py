...
def main():
    ...
    try:
        ...
        print("\n📝 Creating Confluence Daily Standup page...")
        
        today = datetime.now().strftime('%Y-%m-%d')
        page_title = f"Daily Standup - {today}"
        
        confluence_content = f"""# Daily Standup - {today}
...
---
*Generated by PM Standup Agent*"""
        
        # Create the Confluence page
        confluence_page = confluence.create_page(page_title, confluence_content)
        print(f"✅ Confluence page created: {confluence_page['url']}")
        
        # Send Slack notification with Confluence link
        ...
        print(f"📝 Confluence page: {confluence_page['url']}")
